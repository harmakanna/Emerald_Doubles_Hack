...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO_HOENNIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FIRE_POUCH, ABILITY_SNOW_CLOAK, ABILITY_ICY_PELT },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("H-Skiddo"),
        .cryId = CRY_SKIDDO,
        .natDexNum = NATIONAL_DEX_SKIDDO,
        .categoryName = _("Mount"),
        .height = 9,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_SkiddoHoennian,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Skiddo_Hoennian,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_SkiddoHoennian,
        .backPicSize = MON_COORDS_SIZE(56, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_SkiddoHoennian,
        .shinyPalette = gMonShinyPalette_SkiddoHoennian,
        .iconSprite = gMonIcon_SkiddoHoennian,
        .iconPalIndex = 1,
        FOOTPRINT(Skiddo)
        OVERWORLD(
            sPicTable_Skiddo,
        ...
        .levelUpLearnset = sSkiddoHoennianLevelUpLearnset,
        .teachableLearnset = sSkiddoHoennianTeachableLearnset,
        .eggMoveLearnset = sSkiddoHoennianEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_MAPSEC, MAPSEC_METEOR_PEAK, SPECIES_GOGOAT_HOENNIAN}),
    },
    ...
    [SPECIES_GOGOAT_HOENNIAN] =
    {
        ...
        .trainerScale = 290,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_GogoatHoennian,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_Gogoat_Hoennian,
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_GogoatHoennian,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = gMonPalette_GogoatHoennian,
        .shinyPalette = gMonShinyPalette_GogoatHoennian,
        .iconSprite = gMonIcon_GogoatHoennian,
        .iconPalIndex = 1,
        FOOTPRINT(Gogoat)
        OVERWORLD(
            sPicTable_Gogoat,
        ...
        .levelUpLearnset = sGogoatHoennianLevelUpLearnset,
        .teachableLearnset = sGogoatHoennianTeachableLearnset,
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_CARBINK_HOENNIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_CarbinkHoennian,
        .frontPicSize = MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Carbink_Hoennian,
        .frontAnimId = ANIM_ZIGZAG_SLOW,
        .enemyMonElevation = 4,
        .backPic = gMonBackPic_CarbinkHoennian,
        .backPicSize = MON_COORDS_SIZE(56, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = gMonPalette_CarbinkHoennian,
        .shinyPalette = gMonShinyPalette_CarbinkHoennian,
        .iconSprite = gMonIcon_CarbinkHoennian,
        .iconPalIndex = 2,
        FOOTPRINT(Carbink)
        OVERWORLD(
            sPicTable_Carbink,
        ...
        .levelUpLearnset = sCarbinkHoennianLevelUpLearnset,
        .teachableLearnset = sCarbinkHoennianTeachableLearnset,
    },
#endif //P_HOENNIAN_FORMS
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_HYDRATION, ABILITY_GOOEY, ABILITY_RAIN_DISH },
    ...
    [SPECIES_GOODRA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_DRIZZLE, ABILITY_GOOEY, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .abilities = { ABILITY_FOREWARN, ABILITY_DRY_ICE, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_DRY_ICE, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLUE,
