...
static const u8 sText_PkmnGainedEXPALL[] = _("The rest of the party gained\nat least {B_BUFF3} EXP!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_CANNOTUSEGIGATONHAMMER - BATTLESTRINGS_TABLE_START] = sText_CannotUseGigatonHammer,
};
