...
const u32 gItemIcon_MegaStone[] = INCBIN_U32("graphics/items/icons/mega_stone.4bpp.lz");
...
const u32 gItemIcon_ExpHold[] = INCBIN_U32("graphics/items/icons/exp_share.4bpp.lz");
const u32 gItemIconPalette_ExpHold[] = INCBIN_U32("graphics/items/icon_palettes/exp_share.gbapal.lz");
