...
//Item Definitions for gEvolutionTable
    ...
    #define ITEM_MEGA_STONE          10060
    #define ITEM_TART_APPLE          10061
    #define ITEM_SWEET_APPLE         10062
    #define ITEM_CRACKED_POT         10063
    #define ITEM_GALARICA_CUFF       10064
    #define ITEM_GALARICA_WREATH     10065
    #define ITEM_CHIPPED_POT         10066
