...
const u8 gMonIcon_MienfooHoennian[] = INCBIN_U8("graphics/pokemon/hoennian_mienfoo/icon.4bpp");
const u8 gMonIcon_MienshaoHoennian[] = INCBIN_U8("graphics/pokemon/hoennian_mienshao/icon.4bpp");
const u8 gMonIcon_DiancieHoennian[] = INCBIN_U8("graphics/pokemon/hoennian_diancie/icon.4bpp");
