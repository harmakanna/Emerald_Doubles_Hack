...
static void CreateStartMenuForPokenavTutorial(void)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_MenuOptionPc, 8, 41, TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_MenuOptionBag, 8, 57, TEXT_SKIP_DRAW, NULL);
...
static const u8 sText_JolteonSpecialEvo[] = _("Jolteon");
static const u8 sText_VaporeonSpecialEvo[] = _("Vaporeon");
static const u8 sText_FlareonSpecialEvo[] = _("Flareon");
static const u8 sText_EspeonSpecialEvo[] = _("Espeon");
static const u8 sText_UmbreonSpecialEvo[] = _("Umbreon");
static const u8 sText_LeafeonSpecialEvo[] = _("Leafeon");
static const u8 sText_GlaceonSpecialEvo[] = _("Glaceon");
static const u8 sText_SylveonSpecialEvo[] = _("Sylveon");

// Sets of multichoices.
static const struct ListMenuItem sEeveeOverworldEvoOptions[] =
{
    {sText_JolteonSpecialEvo, 0},
    {sText_VaporeonSpecialEvo, 1},
    {sText_FlareonSpecialEvo, 2},
    {sText_EspeonSpecialEvo, 3},
    {sText_UmbreonSpecialEvo, 4},
    {sText_LeafeonSpecialEvo, 5},
    {sText_GlaceonSpecialEvo, 6},
    {sText_SylveonSpecialEvo, 7},
};
...
{
    {sEeveeOverworldEvoOptions, ARRAY_COUNT(sEeveeOverworldEvoOptions)},
};
