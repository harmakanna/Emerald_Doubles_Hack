...
#define STRINGID_PKMNMAKESWATERMISS                   665
#define STRINGID_PKMNCUTSSPATTACKWITH                 666
#define STRINGID_PKMNSXPREVENTSFROSTBITE              667
#define STRINGID_CANNOTUSEGIGATONHAMMER               668
#define STRINGID_PKMNGAINEDEXPALL                     669
