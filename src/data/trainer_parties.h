...
static const struct TrainerMonCustomized sParty_ShellyWeatherInstitute[] = {
    ...
    .moves = {MOVE_CLAMP, MOVE_BLIZZARD, MOVE_IRON_DEFENSE, MOVE_SCALD},
    },
    {
    .iv = 175,
    .lvl = 32,
    ...
    .moves = {MOVE_ICE_FANG, MOVE_SUCKER_PUNCH, MOVE_IRON_HEAD, MOVE_FAKE_TEARS},
    },
    {
    .iv = 200,
    .lvl = 33,
    ...
    .moves = {MOVE_AIR_SLASH, MOVE_EXTRASENSORY, MOVE_DAZZLING_GLEAM, MOVE_LIFE_DEW},
    },
    {
    .iv = 200,
    .lvl = 33,
    ...
    .moves = {MOVE_AIR_CUTTER, MOVE_SHOCK_WAVE, MOVE_ROOST, MOVE_AGILITY},
    },
    {
    .iv = 250,
    .lvl = 34,
    ...
    .moves = {MOVE_DOUBLE_EDGE, MOVE_WATERFALL, MOVE_ROCK_SLIDE, MOVE_REST},
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .lvl = 28,
    .species = SPECIES_DRILBUR,
    .moves = {MOVE_FURY_SWIPES, MOVE_METAL_CLAW, MOVE_DIG, MOVE_RAPID_SPIN}
    },
    {
    .iv = 50,
    .lvl = 27,
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_SELF_DESTRUCT, MOVE_ROCK_POLISH, MOVE_SPARK}
    },
    {
    .iv = 50,
    .lvl = 32,
    .species = SPECIES_GRAVELER_ALOLAN,
    .moves = {MOVE_ROCK_TOMB, MOVE_SELF_DESTRUCT, MOVE_SANDSTORM, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 50,
    .lvl = 32,
    .species = SPECIES_PUPITAR,
    .moves = {MOVE_SMACK_DOWN, MOVE_PAYBACK, MOVE_SCREECH, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonCustomized sParty_GabbyAndTy6[] = {
    ...
    .moves = {MOVE_BOOMBURST, MOVE_CRUNCH, MOVE_SUPERSONIC, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonCustomized sParty_Ricky1[] = {
    ...
    .moves = {MOVE_WATER_GUN, MOVE_SUPERSONIC, MOVE_THUNDER_WAVE, MOVE_ELECTRO_BALL}
    }
};
...
static const struct TrainerMonCustomized sParty_Randall[] = {
    ...
    .moves = {MOVE_BELLY_DRUM, MOVE_EXTREME_SPEED, MOVE_SHADOW_CLAW, MOVE_NONE}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .moves = {MOVE_FLING, MOVE_SLASH, MOVE_FOUL_PLAY, MOVE_NONE}
    }
};
...
static const struct TrainerMonCustomized sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_VOICE, MOVE_FAKE_OUT, MOVE_THUNDER_WAVE, MOVE_HELPING_HAND}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .species = SPECIES_LOUDRED,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_VOICE, MOVE_BRICK_BREAK, MOVE_WORK_UP, MOVE_NONE}
    }
};
...
static const struct TrainerMonCustomized sParty_George[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLACK_OFF, MOVE_COUNTER, MOVE_SLASH, MOVE_SHADOW_CLAW}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .species = SPECIES_GIRAFARIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MILK_DRINK, MOVE_MIRROR_COAT, MOVE_PSYBEAM, MOVE_NONE}
    }
};
...
static const struct TrainerMonCustomized sParty_Berke[] = {
    ...
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RETURN, MOVE_ROUND, MOVE_HYPER_VOICE, MOVE_HELPING_HAND}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RETURN, MOVE_ROUND, MOVE_DAZZLING_GLEAM, MOVE_HEAL_PULSE}
    }
};
...
static const struct TrainerMonCustomized sParty_Braxton[] = {
    ...
    .species = SPECIES_GRAFAIAI,
    .moves = {MOVE_ACID_SPRAY, MOVE_SWAGGER, MOVE_PARTING_SHOT, MOVE_METRONOME}
    },
    {
    .iv = 150,
    .lvl = 34,
    ...
    .species = SPECIES_LOUDRED,
    .moves = {MOVE_HYPER_VOICE, MOVE_ROAR, MOVE_REST, MOVE_SLEEP_TALK}
    },
    {
    .iv = 150,
    .lvl = 35,
    .species = SPECIES_SHIFTRY,
    .moves = {MOVE_TAILWIND, MOVE_AIR_CUTTER, MOVE_RAZOR_LEAF, MOVE_KNOCK_OFF}
    },
    {
    .iv = 150,
    .lvl = 35,
    ...
    .moves = {MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_DISCHARGE, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 200,
    .lvl = 36,
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_SELF_DESTRUCT, MOVE_DRILL_RUN, MOVE_AUTOTOMIZE}
    }
};
...
static const struct TrainerMonCustomized sParty_Wilton1[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_FAKE_OUT, MOVE_BULLET_PUNCH, MOVE_FORCE_PALM}
    },
    {
    .iv = 100,
    ...
    .moves = {MOVE_TAILWIND, MOVE_PSYBEAM, MOVE_YAWN, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 100,
    ...
    .moves = {MOVE_POUNCE, MOVE_WING_ATTACK, MOVE_QUICK_ATTACK, MOVE_QUICK_GUARD}
    }
};
...
static const struct TrainerMonCustomized sParty_Alexia[] = {
    ...
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .species = SPECIES_LOUDRED,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_SHOCK_WAVE, MOVE_EXTRASENSORY, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonCustomized sParty_Jody[] = {
    ...
    .moves = {MOVE_PARTING_SHOT, MOVE_WING_ATTACK, MOVE_FURY_ATTACK, MOVE_BATON_PASS}
    },
    {
    .iv = 250,
    .lvl = 28,
    ...
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DIZZY_PUNCH, MOVE_ICY_WIND, MOVE_PSYBEAM, MOVE_BATON_PASS}
    },
    {
    .iv = 250,
    .lvl = 28,
    ...
    .species = SPECIES_GIRAFARIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SKILL_SWAP, MOVE_CALM_MIND, MOVE_STOMP, MOVE_BATON_PASS}
    },
    {
    .iv = 250,
    .lvl = 28,
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CHARM, MOVE_HYPER_VOICE, MOVE_CALM_MIND, MOVE_BATON_PASS}
    }
};
...
static const struct TrainerMonCustomized sParty_Wendy[] = {
    ...
    .ability = ABILITY_INTIMIDATE,
    .species = SPECIES_MAWILE,
    .moves = {MOVE_ATTRACT, MOVE_TAUNT, MOVE_METAL_CLAW, MOVE_ASSURANCE}
    },
    {
    .iv = 150,
    .lvl = 34,
    ...
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_FACADE, MOVE_AERIAL_ACE, MOVE_AGILITY, MOVE_REVERSAL}
    },
    {
    .iv = 150,
    .lvl = 35,
    ...
    .moves = {MOVE_HAIL, MOVE_AVALANCHE, MOVE_BODY_SLAM, MOVE_REST}
    },
    {
    .iv = 150,
    .lvl = 35,
    ...
    .moves = {MOVE_ACID_SPRAY, MOVE_DRAINING_KISS, MOVE_POISON_GAS, MOVE_ENCORE}
    },
    {
    .iv = 200,
    .lvl = 36,
    ...
    .moves = {MOVE_VENOSHOCK, MOVE_MAGICAL_LEAF, MOVE_WEATHER_BALL, MOVE_INGRAIN}
    }
};
...
static const struct TrainerMonCustomized sParty_Brooke1[] = {
  ...
  .moves = {MOVE_FLAME_CHARGE, MOVE_BITE, MOVE_HOWL, MOVE_MORNING_SUN}
  },
  {
  .iv = 100,
  .ability = ABILITY_PSYCH_OUT,
  .lvl = 21,
  .species = SPECIES_GIRAFARIG,
  .moves = {MOVE_STOMP, MOVE_CONFUSION, MOVE_GUARD_SWAP, MOVE_REFLECT}
  },
  {
  .iv = 100,
  ...
  .lvl = 21,
  .species = SPECIES_TOGETIC,
  .moves = {MOVE_FOLLOW_ME, MOVE_HELPING_HAND, MOVE_DRAINING_KISS, MOVE_MAGICAL_LEAF}
  }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .moves = {MOVE_PIN_MISSILE, MOVE_LEER, MOVE_INGRAIN, MOVE_BULLET_SEED}
    },
    {
    .iv = 0,
    .lvl = 27,
    .species = SPECIES_SWINUB,
    .moves = {MOVE_DIG, MOVE_POWDER_SNOW, MOVE_ICE_SHARD, MOVE_MUD_SLAP}
    }
};
...
static const struct TrainerMonCustomized sParty_Roxanne1[] = {
    {
    .iv = TRAINER_PARTY_IVS(12,8,12,8,8,12),
    .lvl = 12,
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_LEECH_SEED, MOVE_ACID, MOVE_ABSORB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12,12,8,12,8,8),
    .lvl = 12,
    ...
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_HONE_CLAWS, MOVE_FURY_CUTTER, MOVE_CUT, MOVE_ROCK_SMASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(12,8,12,8,8,12),
    .lvl = 12,
    ...
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_ROCK_TOMB, MOVE_SANDSTORM, MOVE_THUNDER_WAVE, MOVE_TORMENT}
    },
    {
    .iv = TRAINER_PARTY_IVS(10,15,10,15,10,20),
    .lvl = 13,
    ...
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_TRAILBLAZE, MOVE_FLAIL}
    }
};
...
static const struct TrainerMonCustomized sParty_Wattson1[] = {
  ...
  .nature = TRAINER_PARTY_NATURE(NATURE_CALM),
  .gender = TRAINER_MON_MALE,
  .moves = {MOVE_DISARMING_VOICE, MOVE_ENCORE, MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK}
  },
  {
  ...
  .gender = TRAINER_MON_MALE,
  .moves = {MOVE_NUZZLE, MOVE_HELPING_HAND, MOVE_TEARFUL_LOOK, MOVE_DRAINING_KISS}
  },
  {
  ...
  .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
  .gender = TRAINER_MON_MALE,
  .moves = {MOVE_ELECTROWEB, MOVE_STRUGGLE_BUG, MOVE_DOUBLE_TEAM, MOVE_GIGA_DRAIN}
  },
  {
  ...
  .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
  .gender = TRAINER_MON_MALE,
  .moves = {MOVE_SHOCK_WAVE, MOVE_SLACK_OFF, MOVE_WATER_PULSE, MOVE_SOAK}
  },
  {
  ...
  .moves = {MOVE_SHOCK_WAVE, MOVE_OMINOUS_WIND, MOVE_PROTECT, MOVE_SUBSTITUTE}
  }
};
...
static const struct TrainerMonCustomized sParty_Flannery1[] = {
    ...
    .moves = {MOVE_PETAL_DANCE, MOVE_WEATHER_BALL, MOVE_SYNTHESIS, MOVE_GROWTH}
    },
    {
    .iv = 200,
    .lvl = 27,
    ...
    .moves = {MOVE_REHEARSAL, MOVE_AIR_CUTTER, MOVE_ICY_WIND, MOVE_FEATHER_DANCE}
    },
    {
    .iv = 200,
    .lvl = 27,
    ...
    .moves = {MOVE_FLAME_CHARGE, MOVE_TAKE_DOWN, MOVE_MORNING_SUN, MOVE_WILL_O_WISP}
    },
    {
    .iv = 225,
    .lvl = 26,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_FIRE_SPIN, MOVE_BODY_SLAM, MOVE_ATTRACT}
    },
    {
    .iv = 225,
    .lvl = 28,
    ...
    .moves = {MOVE_LAVA_PLUME, MOVE_YAWN, MOVE_ANCIENT_POWER, MOVE_CLEAR_SMOG}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .moves = {MOVE_SCALD, MOVE_FLAMETHROWER, MOVE_LIFE_DEW, MOVE_ENCORE}
    }
};
...
static const struct TrainerMonCustomized sParty_Norman1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FACADE, MOVE_SLACK_OFF, MOVE_FEINT, MOVE_SHADOW_CLAW}
    },
    {
    .iv = 225,
    .lvl = 29,
    ...
    .species = SPECIES_GRAFAIAI,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOODLE, MOVE_KNOCK_OFF, MOVE_GUNK_SHOT, MOVE_PARTING_SHOT}
    },
    {
    .iv = 200,
    .lvl = 30,
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_SNARL, MOVE_ICY_WIND, MOVE_CHARM}
    },
    {
    .iv = 200,
    .lvl = 29,
    ...
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_VOICE, MOVE_FLAMETHROWER, MOVE_ICE_BEAM, MOVE_STOMP}
    },
    {
    .iv = 200,
    .lvl = 30,
    ...
    .species = SPECIES_DRAMPA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_DRAGON_BREATH, MOVE_HEAT_WAVE, MOVE_REST, MOVE_SNORE}
    },
    {
    .iv = 250,
    .lvl = 31,
    ...
    .heldItem = ITEM_FLAME_ORB,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_SUBMISSION, MOVE_MAT_BLOCK, MOVE_HIGH_HORSEPOWER}
    }
};
...
static const struct TrainerMonCustomized sParty_Winona1[] = {
    ...
    .moves = {MOVE_ENDEAVOR, MOVE_FEATHER_DANCE, MOVE_AERIAL_ACE, MOVE_BOOMBURST}
    },
    {
    .iv = 200,
    .lvl = 33,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_HEAT_WAVE, MOVE_WATER_PULSE, MOVE_TAILWIND}
    },
    {
    .iv = 200,
    .lvl = 32,
    ...
    .moves = {MOVE_BRAVE_BIRD, MOVE_JUMP_KICK, MOVE_DOUBLE_EDGE, MOVE_MIRROR_MOVE}
    },
    {
    .iv = 220,
    .lvl = 34,
    ...
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_GIGA_DRAIN, MOVE_AIR_CUTTER, MOVE_BULLDOZE, MOVE_BREAKING_SWIPE}
    },
    {
    .iv = 220,
    .lvl = 34,
    ...
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_COTTON_GUARD, MOVE_AIR_SLASH, MOVE_DAZZLING_GLEAM, MOVE_ROOST}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TAIL_GLOW, MOVE_HURRICANE, MOVE_MOONBLAST, MOVE_MOONLIGHT}
    }
};
...
static const struct TrainerMonCustomized sParty_KateAndJoy[] = {
    ...
    .ability = ABILITY_PURE_POWER,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_HYPNOSIS, MOVE_SKILL_SWAP, MOVE_FEINT, MOVE_HIGH_JUMP_KICK}
    },
    {
    .iv = 0,
    .lvl = 34,
    .ability = ABILITY_TRUANT,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_HAMMER_ARM, MOVE_YAWN, MOVE_SLACK_OFF, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vicky[] = {
    ...
    .lvl = 17,
    .species = SPECIES_CHIMECHO,
    .moves = {MOVE_CALM_MIND, MOVE_YAWN, MOVE_CONFUSION, MOVE_ICY_WIND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .lvl = 10,
    .species = SPECIES_GEODUDE_ALOLAN,
    .moves = {MOVE_TACKLE, MOVE_CHARGE, MOVE_ROLLOUT, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 10,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_DEFENSE_CURL, MOVE_SCRATCH, MOVE_ROLLOUT, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 19,
    .species = SPECIES_TADBULB,
    .moves = {MOVE_WATER_GUN, MOVE_CHARGE, MOVE_THUNDER_SHOCK, MOVE_MUD_SLAP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_GULPIN,
    .moves = {MOVE_POISON_GAS, MOVE_POUND, MOVE_YAWN, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 17,
    ...
    .lvl = 17,
    .species = SPECIES_GRIMER,
    .moves = {MOVE_DISABLE, MOVE_POUND, MOVE_SLUDGE, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .lvl = 18,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_FIRE_SPIN, MOVE_TACKLE, MOVE_MAGNITUDE, MOVE_SUNNY_DAY}
    },
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_FLAME_BURST, MOVE_TACKLE, MOVE_MAGNITUDE, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Angelica[] = {
    ...
    .moves = {MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_SOLAR_BEAM, MOVE_FLAMETHROWER}
    },
    {
    .iv = 50,
    .lvl = 30,
    .species = SPECIES_SUNFLORA,
    .moves = {MOVE_SLEEP_POWDER, MOVE_WEATHER_BALL, MOVE_GIGA_DRAIN, MOVE_SYNTHESIS}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GinaAndMia1[] = {
    ...
    .lvl = 8,
    .species = SPECIES_SHROOMISH,
    .moves = {MOVE_RAGE_POWDER, MOVE_LEECH_SEED},
    },
    {
    .iv = 0,
    .lvl = 7,
    .species = SPECIES_WINGULL,
    .moves = {MOVE_GROWL, MOVE_WATER_GUN, MOVE_SUPERSONIC},
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kayley[] = {
    ...
    .lvl = 35,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_HAIL, MOVE_WEATHER_BALL, MOVE_BLIZZARD, MOVE_THUNDERBOLT}
    },
    {
    .iv = 0,
    .lvl = 35,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_HAIL, MOVE_WEATHER_BALL, MOVE_BLIZZARD, MOVE_ENERGY_BALL}
    }
};
...
static const struct TrainerMonCustomized sParty_BrendanRoute119Mudkip[] = {
    ...
    .moves = {MOVE_SNARL, MOVE_FOUL_PLAY, MOVE_THUNDER_WAVE, MOVE_HELPING_HAND},
    },
    {
    .iv = 175,
    .lvl = 31,
    ...
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_GYRO_BALL, MOVE_SLASH, MOVE_SWORDS_DANCE, MOVE_DRILL_RUN},
    },
    {
    .iv = 175,
    .lvl = 32,
    ...
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_AQUA_RING, MOVE_PERISH_SONG},
    },
    {
    .iv = 175,
    .lvl = 32,
    ...
    .species = SPECIES_NINETALES,
    .moves = {MOVE_SHADOW_BALL, MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_SPITE},
    },
    {
    .iv = 225,
    .lvl = 34,
    ...
    .moves = {MOVE_LEAF_BLADE, MOVE_NIGHT_SLASH, MOVE_DETECT, MOVE_PURSUIT},
    }
};
...
static const struct TrainerMonCustomized sParty_BrendanRoute119Treecko[] = {
    ...
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_MACH_PUNCH, MOVE_BULLET_SEED, MOVE_SPORE, MOVE_COUNTER},
    },
    {
    .iv = 175,
    .lvl = 32,
    ...
    .species = SPECIES_STARMIE,
    .moves = {MOVE_BRINE, MOVE_ICY_WIND, MOVE_MINIMIZE, MOVE_CONFUSE_RAY},
    },
    {
    .iv = 225,
    .lvl = 34,
    ...
    .moves = {MOVE_BLAZE_KICK, MOVE_JUMP_KICK, MOVE_DETECT, MOVE_SLASH},
    }
};
...
static const struct TrainerMonCustomized sParty_BrendanRoute119Torchic[] = {
    ...
    .moves = {MOVE_TAR_SHOT, MOVE_FLAME_WHEEL, MOVE_SCORCHING_SANDS, MOVE_SMACK_DOWN},
    },
    {
    .iv = 175,
    .lvl = 32,
    ...
    .moves = {MOVE_HORN_LEECH, MOVE_HIGH_HORSEPOWER, MOVE_BULK_UP, MOVE_GRASSY_TERRAIN},
    },
    {
    .iv = 225,
    .lvl = 34,
    ...
    .moves = {MOVE_MUDDY_WATER, MOVE_ROCK_SLIDE, MOVE_PROTECT, MOVE_MUD_BOMB},
    }
};
...
static const struct TrainerMonCustomized sParty_MayRoute119Mudkip[] = {
    ...
    .moves = {MOVE_PSYSHOCK, MOVE_FUTURE_SIGHT, MOVE_REFLECT, MOVE_HELPING_HAND},
    },
    {
    .iv = 175,
    .lvl = 31,
    ...
    .moves = {MOVE_ICE_SHARD, MOVE_BODY_SLAM, MOVE_MIST, MOVE_STOMPING_TANTRUM},
    },
    {
    .iv = 175,
    .lvl = 32,
...
static const struct TrainerMonCustomized sParty_TabithaMtChimney[] = {
    ...
    .lvl = 24,
    .species = SPECIES_GROWLITHE,
    .moves = {MOVE_FLAME_WHEEL, MOVE_FLAME_CHARGE, MOVE_BITE, MOVE_HOWL}
    },
    {
    .iv = 200,
    .ability = ABILITY_PRANKSTER,
    .lvl = 24,
    .species = SPECIES_SABLEYE,
    .moves = {MOVE_FAKE_OUT, MOVE_ENCORE, MOVE_NIGHT_SHADE, MOVE_DISABLE}
    },
    {
    .iv = 200,
    .ability = ABILITY_INNER_FOCUS,
    .lvl = 25,
    .species = SPECIES_GOLBAT,
    .moves = {MOVE_POISON_FANG, MOVE_AIR_CUTTER, MOVE_BITE, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 200,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_ROCK_BLAST, MOVE_BULLDOZE, MOVE_STOMP, MOVE_SMACK_DOWN}
    }
};
...
static const struct TrainerMonCustomized sParty_MaxieMtChimney[] = {
    ...
    .lvl = 26,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_SNARL, MOVE_CRUNCH, MOVE_FIRE_FANG, MOVE_THUNDER_FANG}
    },
    {
    ...
    .species = SPECIES_TORKOAL,
    .moves = {MOVE_YAWN, MOVE_HELPING_HAND, MOVE_FLAME_WHEEL, MOVE_PROTECT}
    },
    {
    ...
    .moves = {MOVE_ROCK_POLISH, MOVE_ROCK_SLIDE, MOVE_TAKE_DOWN, MOVE_DRAGON_TAIL}
    },
    {
    ...
    .lvl = 26,
    .species = SPECIES_GLIGAR,
    .moves = {MOVE_AERIAL_ACE, MOVE_TAILWIND, MOVE_SWORDS_DANCE, MOVE_DRILL_RUN}
    },
    {
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_LAVA_PLUME, MOVE_ROCK_SLIDE, MOVE_MAGNITUDE, MOVE_TAKE_DOWN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 33,
    .species = SPECIES_SHUPPET,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SCREECH, MOVE_HEX, MOVE_CURSE}
    }
};
...
static const struct TrainerMonCustomized sParty_ToriAndTia[] = {
    ...
    .lvl = 20,
    .species = SPECIES_SPINDA,
    .moves = {MOVE_HYPNOSIS, MOVE_COPYCAT, MOVE_SKILL_SWAP, MOVE_DIZZY_PUNCH}
    },
    {
    .iv = 0,
    .ability = ABILITY_CONTRARY,
    .lvl = 20,
    .species = SPECIES_SPINDA,
    .moves = {MOVE_FAKE_TEARS, MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_UPROAR}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 22,
    .species = SPECIES_GRAVELER_ALOLAN,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_SPARK, MOVE_ROCK_THROW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .lvl = 30,
    .species = SPECIES_DUSTOX,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_PSYBEAM, MOVE_TOXIC, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_BEAUTIFLY,
    .moves = {MOVE_SILVER_WIND, MOVE_GIGA_DRAIN, MOVE_ATTRACT, MOVE_STUN_SPORE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Smith[] = {
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_VULPIX,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Izzy[] = {
    {
    .iv = 0,
    .lvl = 29,
    .species = SPECIES_CHERRIM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jeremiah[] = {
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_CARVANHA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Luca[] = {
    {
    .iv = 0,
    .lvl = 27,
    .species = SPECIES_LAIRON,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kristi[] = {
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_HORSEA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Vanya[] = {
    {
    .iv = 100,
    .lvl = 38,
    .species = SPECIES_MACHOKE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kingston[] = {
    {
    .iv = 150,
    .lvl = 36,
    .species = SPECIES_SNEASEL,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ajax[] = {
    {
    .iv = 125,
    .lvl = 37,
    .species = SPECIES_KADABRA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Opal[] = {
    {
    .iv = 100,
    .lvl = 37,
    .species = SPECIES_SEADRA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Donovan[] = {
    {
    .iv = 0,
    .lvl = 40,
    .species = SPECIES_FEEBAS,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ross[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_FEEBAS,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Vinnie[] = {
    {
    .iv = 100,
    .lvl = 39,
    .species = SPECIES_RAICHU,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mira[] = {
    {
    .iv = 100,
    .lvl = 39,
    .species = SPECIES_MAWILE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Elias[] = {
    {
    .iv = 0,
    .lvl = 38,
    .species = SPECIES_GYARADOS,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Harper[] = {
    {
    .iv = 100,
    .lvl = 38,
    .species = SPECIES_PRIMEAPE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Evelyn[] = {
    {
    .iv = 100,
    .lvl = 40,
    .species = SPECIES_SEADRA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Miles[] = {
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_BRELOOM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Vlad[] = {
    {
    .iv = 125,
    .lvl = 42,
    .species = SPECIES_CHIMECHO,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Leo[] = {
    {
    .iv = 100,
    .lvl = 41,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Shae[] = {
    {
    .iv = 125,
    .lvl = 41,
    .species = SPECIES_GLALIE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Pearl[] = {
    {
    .iv = 100,
    .lvl = 40,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mateo[] = {
    {
    .iv = 0,
    .lvl = 40,
    .species = SPECIES_NOSEPASS,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Shania[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_BELDUM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mariana[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_BELDUM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Patrick[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_BELDUM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Milo[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_BELDUM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Katerina[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_BELDUM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Emma[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_BELDUM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Artyom[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_BELDUM,
...
static const struct TrainerMonCustomized sParty_WallyLilycove[] = {
    {
    .iv = 200,
    .lvl = 35,
    ...
    .moves = {MOVE_DRAINING_KISS, MOVE_COPYCAT, MOVE_SWIFT, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 250,
    .lvl = 34,
    ...
    .ability = ABILITY_STATIC,
    .moves = {MOVE_SPARK, MOVE_IRON_TAIL, MOVE_NUZZLE, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 250,
    .lvl = 34,
    ...
    .heldItem = ITEM_NONE,
    .ability = ABILITY_MOLD_BREAKER,
    .moves = {MOVE_FAKE_OUT, MOVE_FLASH_CANNON, MOVE_PLAY_ROUGH, MOVE_COVET}
    },
    {
    .iv = 250,
    .lvl = 35,
    ...
    .heldItem = ITEM_NONE,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SYNTHESIS, MOVE_VENOSHOCK, MOVE_POISON_POWDER}
    },
    {
    .iv = 255,
    .lvl = 36,
    ...
    .moves = {MOVE_PSYSHOCK, MOVE_DRAINING_KISS, MOVE_DOUBLE_TEAM, MOVE_CALM_MIND}
    }
};
