...
BattleScript_EffectToxic::
	...
	jumpifability BS_TARGET, ABILITY_FREE_SPIRIT, BattleScript_AbilityProtectsDoesntAffect
	jumpifability BS_TARGET, ABILITY_COMATOSE, BattleScript_AbilityProtectsDoesntAffect
	jumpifability BS_TARGET, ABILITY_PURIFYING_SALT, BattleScript_AbilityProtectsDoesntAffect
...
BattleScript_PsychOutEffect:
	...
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_PsychOutWontDecrease
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
...
BattleScript_SteamShowerCureStatus:
	...
	printstring STRINGID_PKMNSTATUSNORMAL
	waitmessage B_WAIT_TIME_LONG
BattleScript_SteamShowerTryRestoreAlly::
	jumpifbyte CMP_NOT_EQUAL, gBattleCommunication, 0x0, BattleScript_MoveEnd
	addbyte gBattleCommunication, 1
	jumpifnoally BS_TARGET, BattleScript_MoveEnd
	setallytonexttarget BattleScript_SteamShowerActivates
	goto BattleScript_MoveEnd
