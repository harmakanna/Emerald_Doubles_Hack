...
struct SaveBlock1
{
    ...
    // sizeof: 0x3???
    // With the size increase in multiple bag pockets, this Save Block will increase in size
    // due to needing to allocate more bits for the extra slots. Be sure to monitor for
    // memory leaks in case they start happening again.
};
