...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE, TRAINER_ROXANNE_REMATCH, TRAINER_ROXANNE_REMATCH, TRAINER_ROXANNE_REMATCH, TRAINER_ROXANNE_REMATCH, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY, TRAINER_BRAWLY_REMATCH, TRAINER_BRAWLY_REMATCH, TRAINER_BRAWLY_REMATCH, TRAINER_BRAWLY_REMATCH, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON, TRAINER_WATTSON_REMATCH, TRAINER_WATTSON_REMATCH, TRAINER_WATTSON_REMATCH, TRAINER_WATTSON_REMATCH, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY, TRAINER_FLANNERY_REMATCH, TRAINER_FLANNERY_REMATCH, TRAINER_FLANNERY_REMATCH, TRAINER_FLANNERY_REMATCH, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN, TRAINER_NORMAN_REMATCH, TRAINER_NORMAN_REMATCH, TRAINER_NORMAN_REMATCH, TRAINER_NORMAN_REMATCH, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA, TRAINER_WINONA_REMATCH, TRAINER_WINONA_REMATCH, TRAINER_WINONA_REMATCH, TRAINER_WINONA_REMATCH, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA, TRAINER_TATE_AND_LIZA_REMATCH, TRAINER_TATE_AND_LIZA_REMATCH, TRAINER_TATE_AND_LIZA_REMATCH, TRAINER_TATE_AND_LIZA_REMATCH, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN, TRAINER_JUAN_REMATCH, TRAINER_JUAN_REMATCH, TRAINER_JUAN_REMATCH, TRAINER_JUAN_REMATCH, SOOTOPOLIS_CITY),
