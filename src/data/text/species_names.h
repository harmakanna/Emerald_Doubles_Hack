const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_SABLEYE_MEGA] = _("M-Sableye"),
    [SPECIES_MAWILE_MEGA] = _("M-Mawile"),
    [SPECIES_AGGRON_MEGA] = _("Aggron"),
    [SPECIES_MEDICHAM_MEGA] = _("Medicham"),
    [SPECIES_MANECTRIC_MEGA] = _("Manectric"),
    [SPECIES_SHARPEDO_MEGA] = _("M-Sharpedo"),
    [SPECIES_CAMERUPT_MEGA] = _("M-Camerupt"),
    [SPECIES_ALTARIA_MEGA] = _("M-Altaria"),
    [SPECIES_BANETTE_MEGA] = _("M-Banette"),
    ...
    // Squawkabilly
    [SPECIES_SQUAWKABILLY_BLUE] = _("Sqawkabily"),
    [SPECIES_SQUAWKABILLY_WHITE] = _("Sqawkabily"),
    [SPECIES_SQUAWKABILLY_YELLOW] = _("Sqawkabily"),
    // Hoennian Forms
