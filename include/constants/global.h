...
#define BAG_ITEMS_COUNT 50 // Up from 30. 20 used from Rematch entries. POTENTIAL FOR MEMORY LEAK - MAKE SURE TO REVIEW CODE.
#define BAG_KEYITEMS_COUNT 46 // Up from 30. 10 used from Rematch entries.
#define BAG_POKEBALLS_COUNT 16
#define BAG_TMHM_COUNT 108 // Up from 64. 44 used from Rematch entries.
...
#define MAX_REMATCH_ENTRIES 25 // only REMATCH_TABLE_ENTRIES (16) are used. Dropped from 100.
