...
#define AI_FLAG_DO_NOT_SWITCH         (1 << 20)  // AI does not ever switch when battling
#define AI_FLAG_PRESERVE_ORDER        (1 << 21)  // AI will send out new Pokemon in the order that they are set
#define AI_FLAG_TWO_ACES              (1 << 22)  // AI has two ace mons. The last two pokemon will not be used until they're the last ones remaining. TODO unfinished
