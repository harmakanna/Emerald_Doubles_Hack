...
#endif
extern const u32 gMonFrontPic_ObstagoonHoennian[];
extern const u32 gMonFrontPic_SkiddoHoennian[];
extern const u32 gMonFrontPic_GogoatHoennian[];
extern const u32 gMonFrontPic_CarbinkHoennian[];
extern const u32 gMonFrontPic_SeelHoennian[];
extern const u32 gMonFrontPic_DewgongHoennian[];
extern const u32 gMonFrontPic_ChatotHoennian[];
extern const u32 gMonFrontPic_PhioneHoennian[];
extern const u32 gMonFrontPic_MienfooHoennian[];
extern const u32 gMonFrontPic_MienshaoHoennian[];
extern const u32 gMonFrontPic_DiancieHoennian[];
...
#endif
extern const u32 gMonBackPic_ObstagoonHoennian[];
extern const u32 gMonBackPic_SkiddoHoennian[];
extern const u32 gMonBackPic_GogoatHoennian[];
extern const u32 gMonBackPic_CarbinkHoennian[];
extern const u32 gMonBackPic_SeelHoennian[];
extern const u32 gMonBackPic_DewgongHoennian[];
extern const u32 gMonBackPic_ChatotHoennian[];
extern const u32 gMonBackPic_PhioneHoennian[];
extern const u32 gMonBackPic_MienfooHoennian[];
extern const u32 gMonBackPic_MienshaoHoennian[];
extern const u32 gMonBackPic_DiancieHoennian[];
...
#endif
extern const u32 gMonPalette_ObstagoonHoennian[];
extern const u32 gMonPalette_SkiddoHoennian[];
extern const u32 gMonPalette_GogoatHoennian[];
extern const u32 gMonPalette_CarbinkHoennian[];
extern const u32 gMonPalette_SeelHoennian[];
extern const u32 gMonPalette_DewgongHoennian[];
extern const u32 gMonPalette_ChatotHoennian[];
extern const u32 gMonPalette_PhioneHoennian[];
extern const u32 gMonPalette_MienfooHoennian[];
extern const u32 gMonPalette_MienshaoHoennian[];
extern const u32 gMonPalette_DiancieHoennian[];
...
#endif
extern const u32 gMonShinyPalette_ObstagoonHoennian[];
extern const u32 gMonShinyPalette_SkiddoHoennian[];
extern const u32 gMonShinyPalette_GogoatHoennian[];
extern const u32 gMonShinyPalette_CarbinkHoennian[];
extern const u32 gMonShinyPalette_SeelHoennian[];
extern const u32 gMonShinyPalette_DewgongHoennian[];
extern const u32 gMonShinyPalette_ChatotHoennian[];
extern const u32 gMonShinyPalette_PhioneHoennian[];
extern const u32 gMonShinyPalette_MienfooHoennian[];
extern const u32 gMonShinyPalette_MienshaoHoennian[];
extern const u32 gMonShinyPalette_DiancieHoennian[];
...
#endif
extern const u8 gMonIcon_ObstagoonHoennian[];
extern const u8 gMonIcon_SkiddoHoennian[];
extern const u8 gMonIcon_GogoatHoennian[];
extern const u8 gMonIcon_CarbinkHoennian[];
extern const u8 gMonIcon_SeelHoennian[];
extern const u8 gMonIcon_DewgongHoennian[];
extern const u8 gMonIcon_ChatotHoennian[];
extern const u8 gMonIcon_PhioneHoennian[];
extern const u8 gMonIcon_MienfooHoennian[];
extern const u8 gMonIcon_MienshaoHoennian[];
extern const u8 gMonIcon_DiancieHoennian[];
